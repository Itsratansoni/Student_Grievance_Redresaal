...
def complaints(request):
    ...
    if request.method == 'POST':
        ...
        if complaint_form.is_valid():
               ...
               print(mail)
               send_mail('Hi Complaint has been Received', 'Thank you for letting us know of your concern, Have a Cookie while we explore into this matter.  Dont Reply to this mail', 'temp.mail089089@gmail.com', [mail],fail_silently=False)
               instance.save()
...
def allcomplaints(request):
        ...
        if request.method=='POST':
                ...
                if forms.is_valid():
                        ...
                        print(m)
                        send_mail('Hi, Complaint has been Resolved ', 'Thanks for letting us know of your concern, Hope we have solved your issue. Dont Reply to this mail', 'temp.mail089089@gmail.com', [m],fail_silently=False)
                        obj.save()
